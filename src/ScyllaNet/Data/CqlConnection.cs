...
namespace Scylla.Net.Data
{
    ...
    {
        private ScyllaDbConnectionStringBuilder _connectionStringBuilder;
        ...
        {
            _connectionStringBuilder = new ScyllaDbConnectionStringBuilder();
        }
        ...
        {
            _connectionStringBuilder = new ScyllaDbConnectionStringBuilder(connectionString);
        }
        ...
        public override string ConnectionString
        {
            ...
            set
            {
                _connectionStringBuilder = new ScyllaDbConnectionStringBuilder(value);
            }
        }
        ...
        /// </summary>
        /// <param name="connectionStringBuilder">The <see cref="Scylla.Net.ScyllaDbConnectionStringBuilder"/>.</param>
        /// <returns></returns>
