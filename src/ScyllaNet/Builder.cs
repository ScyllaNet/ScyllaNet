...
namespace Scylla.Net
{
    ...
    public class Builder : IInitializer
    {
        ...
        {
            var cnb = new ScyllaDbConnectionStringBuilder(connectionString);
        ...
        /// </summary>
        /// <remarks>
        /// If you want to define a read timeout at a lower level, you can use <see cref="Scylla.Net.SocketOptions.SetReadTimeoutMillis(int)"/>.
        /// </remarks>
