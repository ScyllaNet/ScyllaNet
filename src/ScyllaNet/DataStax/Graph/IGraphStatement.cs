...
namespace Scylla.Net.DataStax.Graph
{
    ...
    public interface IGraphStatement
    {
        ...
        /// respectively
        /// <see cref="SetGraphReadConsistencyLevel(Scylla.Net.ConsistencyLevel)"/> and
        /// <see cref="SetGraphWriteConsistencyLevel(Scylla.Net.ConsistencyLevel)"/> will override the consistency set
        /// here.
        /// </para>
        /// </summary>
        ...
        /// <see cref="SetConsistencyLevel(Scylla.Net.ConsistencyLevel)"/> only for the READ part of the graph query.
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// This setting will override the consistency level set with 
        /// <see cref="SetConsistencyLevel(Scylla.Net.ConsistencyLevel)"/> only for the WRITE part of the graph query.
        /// </para>
        /// </summary>
